...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://brand-shop-server-beige.vercel.app/products/${params.id}`)
      ...
      },
      {
        ...
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/myCarts`)
      },

      {
        path: "/appleItems",
        element: <AppleItems></AppleItems>,
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/apple`)
        
      },
      {
        path: "/samsungItems",
        element: <SamsungItems></SamsungItems>,
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/samsung`)
        
      },
      {
        path: "/sonyItems",
        element: <SonyItems></SonyItems> ,
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/sony`)
      },
      {
        path: "/googleItems",
        element: <GoogleItems></GoogleItems>,
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/google`)

      },
      {
        path: "/microsoftItems",
        element: <MicrosoftItems></MicrosoftItems>,
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/microsoft`)
      },
      {
        path: "/intelItems",
        element: <IntelItems></IntelItems>,
        loader: () => fetch(`https://brand-shop-server-beige.vercel.app/intel`)
      }
    ]
  },
]);
